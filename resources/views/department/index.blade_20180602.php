...
@if (Session::has('del_department'))                                             
    <script>layer.msg('{{ session()->get("del_department") }}', {icon: 1});</script>
@endif
...
$(function(){
    $("#iy_manage .treeview a:contains('部门管理')").parent().addClass('active');
      ...
      /*删除部门
      $(".bm_del").on("click",{a:"0"},function(e){
    ...
    $(".add_bm").on("click",function(){
      //$(".models").fadeIn();
  	  ...
  	  $(".layui-layer-btn0").on("click",submit_dpt);
  	  //$(".layui-layer-btn0").click(addnew_dpt);
  	  
  	  $("#newdiv").fadeIn();
    });
	
    /*保存*/
    $(".layui-layer-btn0000").on("click",function(){
